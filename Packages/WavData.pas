...
type
  ...
  public
    ...
    procedure ReadWave;
    function FullDisplayedDataGenerate(NewLength: integer; InterpolationMode: integer = 0): TDisplayedData;
  end;
...
function TWavData.FullDisplayedDataGenerate(NewLength: integer; InterpolationMode: integer = 0): TDisplayedData;
var
  OldLength: integer;
  FactorSize: Real;
  MaxS, MinS: integer;
